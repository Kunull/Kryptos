...
with tab1:
  ...
  encrypt_key = st.number_input('Insert a key from 1 to 25', min_value=1, max_value=25, step=1, key=2)
...
with tab2:
  ...
  decrypt_key = st.number_input('Insert a key from 1 to 25', min_value=1, max_value=25, step=1, key=4)
